...
-- LIMPIAR PREGUNTAS (OPCIONAL PERO RECOMENDADO)
DELETE FROM preguntas;

-- TODAS LAS PREGUNTAS (TU SCRIPT COMPLETO)
...
";
                    ...
                    Console.WriteLine("BD creada y llena correctamente");
                }
            }
            catch (Exception ex)
            {
